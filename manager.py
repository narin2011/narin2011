...
def banner():
    ...
    print(f' Version: 3.0 | Telegram Handler: @Nv_narin{n}\n')
    ...
    if a == 1:
        ...
        with open('vars.txt', 'ab') as g:
            ...
            for number in new_accs:
                c = TelegramClient(f'sessions/{number}', 26293654 , '8a8fe41a531234eb36a0defcbc247adb')
                c.start(number)
        ...
        if not accounts:
            ...
            for account in accounts:
                phone = str(account[0])
                client = TelegramClient(f'sessions/{phone}', 26293654 , '8a8fe41a531234eb36a0defcbc247adb')
                client.connect()
        ...
        try:
           #  https://raw.githubusercontent.com/narin2011/Telegram-Members-Adder/main/version.txt
            version = requests.get('https://raw.githubusercontent.com/narin2011/Telegram-Members-Adder/main/version.txt')
        except:
        ...
        if float(version.text) > 2.0:
            ...
            if prompt in {'y', 'yes', 'Y'}:
                ...
                os.system('curl -l -O https://raw.githubusercontent.com/narin2011/Telegram-Members-Adder/main/add.py')
                os.system('curl -l -O https://raw.githubusercontent.com/narin2011/Telegram-Members-Adder/main/manager.py')
